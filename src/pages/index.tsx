...
export default function IndexPage() {
    return (
        <>
            <Head>
                <title>Moderedom | Anti-virus bot for your Telegram conversations</title>
            </Head>
            <div className="container w-full flex flex-col lg:flex-row items-center gap-12 mt-14 lg:mt-28">
                <div className="flex flex-col lg:w-5/12 items-center lg:items-start">
                    <h2 className="text-4xl text-center lg:text-left mb-6">Anti-virus bot for your Telegram
                        conversations</h2>
                    ...
                    <div className="flex justify-center flex-wrap gap-6 mb-6">
                        <a href="https://t.me/moderedom_bot" target="_blank" rel="noopener noreferrer"
                           className="btn btn-purple">Get it on Telegram</a>
                ...
                <div className="flex justify-center w-full lg:w-7/12 mb-10 md:mb-16 min-w-[325px]">
                    <div
                        ...
                        {/*  Request from user */}
                        <div
                            className="flex items-end justify-start space-x-2 mb-4 md:max-w-3/4 sm:max-w-full sm:min-w-72 ">
                        ...
                        {/*  Response from bot */}
                        <div
                            className="flex items-end justify-start space-x-2 mb-4 md:max-w-3/4 sm:max-w-full min-w-72 ">
                            <div className="flex-shrink-0 w-10 h-10">
                            ...
                            <div className="bg-white text-gray-900 p-3 rounded-lg shadow max-w-full min-w-56">
                                ...
                                <p className="p-tg"><strong>🚨 Heads up! We
                                    found &#39;Win.Malware.Dexter-9654223-0&#39; in
                                    your file.</strong></p>
