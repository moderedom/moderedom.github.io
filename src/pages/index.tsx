...
export default function IndexPage() {
    return (
        <div className="container w-full flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-28">
            <div className="flex flex-col lg:w-5/12 items-center lg:items-start">
                <h2 className="text-mdm-blue text-2xl md:text-4xl lg:text-3xl text-center lg:text-left mb-6">Anti-virus bot for your Telegram conversations</h2>
                ...
                <div className="flex justify-center flex-wrap gap-6 mb-6">
                    <button type="button" className="btn btn-purple">Get it on Telegram</button>
                    <button type="button" className="btn btn-white">More on Features...</button>
                </div>
            </div>
            <div className="flex justify-center w-full lg:w-7/12 mb-10 md:mb-16 min-w-[428px]">
                <div
                    className="bg-tg-wallpaper bg-[length:300px_500px] bg-contain rounded-lg shadow-lg p-4 w-full min-h-96">
                    {/*  Request from user */}
                    <div className="flex items-end justify-start space-x-2 mb-4 md:max-w-3/4 sm:max-w-full sm:min-w-96 ">
                        <div className="flex-shrink-0 w-10 h-10">
                            <Image src={user1Img} alt="User sending a message"
                                   className="w-full h-full rounded-full object-cover"/>
                        </div>
                        <div className="bg-green-100 w-3/4 text-gray-900 p-3 rounded-lg shadow">
                    ...
                    {/*  Response from bot */}
                    <div className="flex items-end justify-start space-x-2 mb-4 md:max-w-3/4 sm:max-w-full min-w-96 ">
                        <div className="flex-shrink-0 w-10 h-10">
                            <Image src={logoBot} alt="Anti-virus bot logo"
                                   className="w-full h-full rounded-full object-cover"/>
                        </div>
                        <div className="bg-white text-gray-900 p-3 rounded-lg shadow max-w-full min-w-72">
                            <div
